    ...
    <Section className="overflow-hidden">
      ...
      <Stagger className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {ENGAGEMENTS.map((item) => (
          <StaggerItem key={item.title} className="h-full">
            <article className="group relative flex h-full flex-col overflow-hidden rounded-sm border border-border bg-card/40 p-8 transition-all duration-300 hover:-translate-y-1.5 hover:border-accent/50 hover:bg-card/70 hover:shadow-2xl hover:shadow-accent/5">
              ...
              <span className="relative flex h-12 w-12 items-center justify-center rounded-full border border-accent/30 text-accent transition-all duration-300 group-hover:border-accent group-hover:bg-accent/10">
                {item.icon}
              </span>
        ...
        <StaggerItem className="h-full">
          <a
            href="#booking"
            className="group relative flex h-full flex-col justify-center overflow-hidden rounded-sm border border-dashed border-accent/40 bg-accent/3 p-8 transition-all duration-300 hover:-translate-y-1.5 hover:border-accent hover:bg-accent/10"
          >
